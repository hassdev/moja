...
<body>
	...
	<script>
		$(document).ready(function() {
			...
			var mx, my, svgw, svgh, xmid, ymid, yini, random, mx_c, mx_c_5, mx_c_10, my_c, point1, point2, text1, text2, angle, rot;
			...
			function render() {
				...
				$("#status1").html("mx: " + mx + "<br>my: " + my + "<br><br>mx_c: " + mx_c + "<br>my_c: " + my_c + "<br>mx_c_10: " + mx_c_10 + "<br><br>svg width: " + svgw + "<br>svg height: " + svgh + "<br><br>xmid: " + xmid + "<br>ymid: " + ymid + "<br>yini: " + yini +
					"<br><br>random a: " + random.a + "<br>random b: " + random.b + "<br>random c: " + random.c);
